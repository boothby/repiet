...
stuff = """                               c02 <nop <psh <ptr 
>ptr >swt >psh >add >dpl >grt >not >psh >dpl ^nop 
^nop       c40 <psh <sbt <psh <swt <nop <psh <ptr 
>ptr >swt >psh >add >dpl >grt >not >psh >dpl ^nop 
^nop       c20 <psh <sbt <psh <swt <nop <psh <ptr 
>ptr >swt >psh >add >dpl >grt >not >psh >dpl ^nop 
^nop       c40 <psh <sbt <psh <swt <nop <psh <ptr 
>ptr >swt >psh >add >dpl >grt >not >psh >dpl ^nop 
^nop       c20 <psh <sbt <psh <swt <nop <psh <ptr """
...
def topbar(n_functions):
    ...
    topleft = """
 c00 <psh <not <psh <sbt <grt <swt <dpl {halt}<grt <swt {_hlt}vnop      
